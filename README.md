...
This is a sample template for redesigned-robot - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name redesigned-robot --query 'Stacks[].Outputs'
```
